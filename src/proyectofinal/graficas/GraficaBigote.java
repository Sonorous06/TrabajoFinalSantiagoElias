...
public class GraficaBigote extends Graficos {
    ...
    private static final Color COLOR_BORDE1 = new Color(180,  50,  50);
    private static final Color COLOR_RELLENO1 = new Color(220,  80,  80);
    private static final Color COLOR_BORDE2 = new Color(200, 120,   0);
    private static final Color COLOR_RELLENO2 = new Color(255, 165,   0);
    ...
    public void dibujarGrafica(Graphics g) {
        ...
        if (mostrarCat1 && misDatos != null) {
            dibujarCaja(g, misDatos, cx1, anchoCaja, yMin, yMax, vMin, vMax, COLOR_BORDE1, COLOR_RELLENO1);
            g.setColor(Color.BLACK);
            g.setFont(new Font("SansSerif", Font.BOLD, 12));
            g.drawString(nombreCat1, cx1 - 6, yMax + 18);
        }
        if (mostrarCat2 && datosCat2 != null) {
            dibujarCaja(g, datosCat2, cx2, anchoCaja, yMin, yMax, vMin, vMax, COLOR_BORDE2, COLOR_RELLENO2);
            g.setColor(Color.BLACK);
            g.setFont(new Font("SansSerif", Font.BOLD, 12));
    ...
    private int calcularMinGlobal() {
        ...
        if (mostrarCat1 && misDatos != null && misDatos.minimo() < min) min = misDatos.minimo();
        if (mostrarCat2 && datosCat2 != null && datosCat2.minimo() < min) min = datosCat2.minimo();
